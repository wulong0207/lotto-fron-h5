...
export default class QXCIndex extends Component {
  constructor(props) {
    super(props);
    this.state = {
      omitFlag: 1
    };
    ZXPage = child(10701, { ...props }, '/qxc/omit', 1, ZX);
  }
