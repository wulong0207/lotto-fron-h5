    ...
    return (
      <div className="select">
        <div className="selector" onClick={ this.toggle.bind(this) }>
          ...
          <img
            className="triangle"
            src={ require('../img/jcl-triangle.png') }
            alt=""
          />
        </div>
...
function BbMatch({ match, selected, toggleBetting }) {
  return (
      ...
      <div className="top">
        <img
          ...
          src={
            match.visitiLogoUrl
              ? match.visitiLogoUrl
              : require('../img/basketball-logo.png')
          }
        />
...
export default class BacketballWidget extends PureComponent {
  constructor(props) {
    super(props);
  ...
  //   if (this.props.onBetNumAndMaxProfitChange) {
  //     const { betNum, maxProfit } = this.getBetNumAndMaxProfit();
  //     this.props.onBetNumAndMaxProfitChange(betNum, maxProfit);
  //   }
  // }
  ...
  changeMatch(id, index) {
    ...
    // if (!bet) {
    //   newBettings = { ...this.state.bettings, [id]: [getSmallestSpBetting(selectMatchs)] };
  ...
  getBetNumAndMaxProfit(matchs, bettings, times) {
    // let { matchs, bettings, times } = this.state;
    const allMatchs = this.props.matchs;
