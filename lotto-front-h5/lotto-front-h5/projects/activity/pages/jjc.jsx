...
import FootballWidget from '../components/football'; // 竞彩足球 组件
import { browser, setDate } from '@/utils/utils'; // 判断浏览器内核
import '../scss/jjc.scss';
...
export class Secact extends Component {
  constructor(props) {
    super(props);
    this.state = {
      matchs: [],
  ...
  tabMult(index) {
    ...
    this.delay = setTimeout(() => {
      ...
      this.football.changeTimes(timer);
  ...
  addOrder(e) {
    ...
    this.state.footData = this.football.getOrderData();
    console.log(this.state.footData);
    this.checkOrder(this.state.footData, 'activity');
  }
  // 下单
          ...
          Message.alert({
            ...
            children: (
              <div className="message-alert">
                <div className="title">温馨提示</div>
                <div className="content">
                  您已经购买竞彩足球了 ！将按原价进行购买。本次投注金额<b className="red">{price}</b>元，祝你中奖！
                </div>
              </div>
            )
          });
          ...
          Message.alert({
            ...
            children: (
              <div className="message-alert">
                <div className="title">温馨提示</div>
                <div className="content">
                  您已经有其他账户购买过竞彩足球了，将按原价购买。 本次投注金额<span>{price}</span>
                  <b>元</b>，祝你中奖！
                </div>
              </div>
            )
  ...
  handleDate(saleEndTime) {
    ...
    // console.log(setDate.formatDate(date, 'yyyy-MM-dd HH:mm:ss'),"111");
  ...
  render() {
    ...
    if (!this.state.matchs.length) {
      ...
      console.log(betNum, maxProfit, timer, 'maxProfit');
      // 原价 活动价 奖金
      ...
      <div className="jjc">
        ...
        <div className="content">
          <div className="banner">
            <img src={ require('../img/caimin@3x.png') } alt="" />
            <span onClick={ this.showExplain.bind(this) }>什么是2串1?</span>
          </div>
          {/* <div className={ cx ('drop-menu' , this.state.menuShow ? '' : 'menu-hide')}>
                        <h3>什么是2串1</h3>
                        <span>两场比赛串在一起，组成一注，必须两场比赛竞猜正确。才算中奖，猜对一场也是没有中奖
                            哦！返奖率高达69%，立即投注体验！
                        </span>
                    </div>  */}
          ...
          {browser.yicaiApp || browser.ios || browser.iPhone ? (
            ...
            <div className="load" onClick={ this.download.bind(this) }>
              <img src={ require('../img/load.png') } alt="" />
            </div>
          )}

          <div className="rule">
            <h3>活动规则：</h3>
            <p>1.本活动仅限未购买过竞彩足球的新用户参与，每位实名用户仅限参与一次；</p>
