    ...
    renderGame(game, i){
        ...
        return <div className="game" key={i}>
            ...
            <div className="bet-select">
                <MatchBar sellMark={1} onCenterClick={toggleSP} onSelect={this.onSelectSF.bind(this)} select={sfs} field="sf" data={game} linebox="lineboxb"/>
                <MatchBar sellMark={1} onCenterClick={toggleSP} onSelect={this.onSelectSF.bind(this)} select={rfsfs} field="rfsf" data={game} linebox="lineboxb"/>
                <MatchBar sellMark={1} onCenterClick={toggleSP} onSelect={this.onSelectSF.bind(this)} select={dxfs} field="dxf" leftTitle="大分" rightTitle="小分" data={game} linebox="lineboxb"/>
                <SFC sellMark={1} select={sfcs} onSelect={this.onSelectSFCPage.bind(this)} data={game}/>
            </div>
        </div>
    }
