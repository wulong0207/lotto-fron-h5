...
export default class Keyboard extends PureComponent {
  ...
  shortcutHandle(shortcut) {
    analytics.send(shortcut.analyticsId);
    this.change(shortcut.value);
  }
  ...
  render() {
    return (
      <PortalComponent show={ this.state.show } klass={ ['keyboard-simulator'] }>
        <div
          ...
          >
            <div className="keyboard-wrap">
              <div className="keyboard-header">
                <div className="keyboard-label">{this.props.label || ''}</div>
                ...
                <div className="shortcuts">
                  {this.props.shortcuts.map(s => {
                    return (
                      <span
                        key={ s.value }
                        onClick={ this.shortcutHandle.bind(this, s) }
                      >
                        {s.label}
                      </span>
                    );
