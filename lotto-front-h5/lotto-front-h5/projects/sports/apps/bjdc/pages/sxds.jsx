...
import SXDS from '../components/sxds.jsx'; // 胜负
...
const lotteryMark = 'sxds';

// 上下单双
class SXDSPage extends LazyPage {
...
export default connect(mapStateToProps, mapDispatchToProps)(SXDSPage);
