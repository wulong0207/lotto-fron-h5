...
import BQC from '../components/bqc.jsx'; // 胜负
...
const lotteryMark = 'bqc';

// 半全场
class BQCPage extends LazyPage {
...
export default connect(mapStateToProps, mapDispatchToProps)(BQCPage);
