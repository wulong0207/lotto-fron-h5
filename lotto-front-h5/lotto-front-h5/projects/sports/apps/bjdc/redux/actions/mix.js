...
export const BASKETBALL_MIX_TOGGLE_MATCH_DETAIL =
...
export const BASKETBALL_MIX_SINGLE_BETTING_TOGGLE =
  'BASKETBALL_MIX_SINGLE_BETTING_TOGGLE';
export const BASKETBALL_MIX_SINGLE_BETTING_CLEAR =
  'BASKETBALL_MIX_SINGLE_BETTING_CLEAR';
export const BASKETBALL_MIX_SINGLE_BETTING_SUBMIT =
...
export function singleBettingToggle(data) {
  return (dispatch, getState) => {
    const selected = getState().basketballBettings.filter(
      b => b.name === 'mix'
    )[0].selected;
