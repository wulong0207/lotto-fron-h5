...
import ZJQS from '../components/zjqs.jsx'; // 胜负
...
const lotteryMark = 'zjqs';

// 上下单双
class ZJQSPage extends LazyPage {
...
export default connect(mapStateToProps, mapDispatchToProps)(ZJQSPage);
