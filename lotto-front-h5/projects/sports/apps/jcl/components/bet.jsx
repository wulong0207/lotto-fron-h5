...
class Bet extends Component {
  ...
  getBetBarDefault() {
    let mode = getCurrentMode();
    let msg = mode === 'single' ? '请至少选择1场比赛' : '请至少选择2场比赛';

    return [
      { title: msg, subTitle: '复式截止时间：赛前8分钟', flex: 1, mark: '' },
      {
      ...
      <div>
        <div className="bet-info-tip" style={ betInfoStyle }>
          ...
          {mode === 'single' ? (
            ...
            <div
              onClick={ this.gotoOptimization.bind(this) }
              className="jiangjin"
            >
              奖金优化
            </div>
