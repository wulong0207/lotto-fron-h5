...
export default class Keyboard extends Component {
  ...
  open(number, showMul, title) {
    this.show(true, showMul, title);
    this.setState({ curNum: number });
  }
  ...
  getKeyBoard() {
    ...
    if (topCustomBtns && this.state.showMul) {
      topCustomBtnsArea = (
      ...
      >
        ...
        <div className="keyboard-area">
          <div className="item-set">
            <div className="txt">{this.state.title || title}</div>
