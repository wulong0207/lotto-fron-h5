...
export default class NumberInput extends PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.number !== this.state.number && nextProps.number !== this.props.number) {
  ...
  foucs() {
    ...
    if (onFocus) onFocus();
    keyboard.open(this.state.number, this.props.showMul, this.props.title);
    ...
    return (
      <div className="number-input-component">
        <div className="number-input-container">
          ...
          <div className="number-input" onClick={ this.foucs.bind(this) }>{ this.state.number }</div>
