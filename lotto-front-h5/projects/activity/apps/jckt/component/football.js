      ...
      <div>
        <div className="matchs">
          ...
          <BetCalc
            ...
            getBetNumAndMaxProfit={ this.getBetNumAndMaxProfit.bind(this) }
            getOrderData={ this.getOrderData.bind(this) }
            bettings={ this.state.bettings }
            matchs={ this.state.matchs }
            times={ this.state.times }
            changeTimes={ this.changeTimes.bind(this) }
            showMatchs={ this.state.showMatchs }
          />
        </div>
      </div>
    );
