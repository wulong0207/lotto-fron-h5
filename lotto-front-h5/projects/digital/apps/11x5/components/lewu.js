...
export default class LEWU extends Component {
  constructor(props) {
    super(props);
    this.state = {
      balls: [],
            ...
            .then(() => {
              ...
              do {
                newBalls = this.state.balls.concat(
                  this.panel.random(5 - ballNumber)
                );
              } while (
                !Common.checkLimit(newBalls, false, this.props.limitInfoList, 5)
              );
        ...
        <BetInfo
          ...
          emptyNode={
            <p className="empty-tip">
              <span>
                任选5个号码，与开奖号码有5个相同的中<em>1080</em>元，有4个相同的中<em
                >
                  90
                </em>元
              </span>
