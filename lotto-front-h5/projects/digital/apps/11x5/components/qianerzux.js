...
export default class QIANERGROUP extends Component {
  ...
  ballRandom(highlight = false) {
    ...
    } while (!Common.checkLimit(balls, false, this.props.limitInfoList, 2));
  ...
  generateBet(balls, manual = true, fixedBalls = []) {
    ...
    return {
      ...
      label: `前二组选${fixedBalls.length ? '胆拖' : '普通'} ${betNum}注`,
        ...
        <BetInfo
          ...
          emptyNode={
            <p className="empty-tip">
              <span>
                任意2个号码组成1注有效注。1/55的中奖机会,奖金<em>65</em>元！
              </span>
              <span>点两次可设胆 [可选择1个胆码]</span>
            </p>
          }
        >
