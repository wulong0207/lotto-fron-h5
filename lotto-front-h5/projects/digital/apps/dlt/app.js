...
export default class SSQIndex extends Component {
  constructor(props) {
    ...
    PTPage = child(10201, { ...props }, '/dlt/omit', 1, PT);
    DTPage = child(10202, { ...props }, '/dlt/omit', 1, DT);
    ...
    return (
      <div className="yc-dlt">
        ...
        <div className="ssq-content">
          {this.renderContent()}
          {/* { React.createElement(child(10401, { ...this.props }, '/h5/ssq/omit', 1, ZX), { onNewOrder: this.newOrder.bind(this), omitFlag: this.state.omitFlag }) } */}
        </div>
        <Orders
