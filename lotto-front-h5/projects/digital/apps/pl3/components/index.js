...
const TBA_SESSION_NAME = 'pl3_tab_page';

export default class PL3Index extends Component {
  constructor(props) {
    super(props);
    ...
    ZXPage = child(10401, { ...props }, '/pl3/omit', 1, ZX);
    ZXHZPage = child(10401, { ...props }, '/pl3/omit', 3, ZXHZ);
    ZX3Page = child(10402, { ...props }, '/pl3/omit', undefined, ZX3);
    HZ3Page = child(10402, { ...props }, '/pl3/omit', 4, HZ3);
    BH3Page = child(10402, { ...props }, '/pl3/omit', 2, BH3);
    BH6Page = child(10403, { ...props }, '/pl3/omit', 2, BH6);
    HZ6Page = child(10403, { ...props }, '/pl3/omit', 5, HZ6);
    DT6Page = child(10403, { ...props }, '/pl3/omit', 5, DT6);
  }
  ...
  render() {
    return (
      <div className="yc-pl3">
        ...
        <div className="pl3-content">
          {this.renderContent()}
          {/* { React.createElement(child(10401, { ...this.props }, '/h5/pl3/omit', 1, ZX), { onNewOrder: this.newOrder.bind(this), omitFlag: this.state.omitFlag }) } */}
        </div>
        <Orders
